...
def p_type_line(p):
    ...
    global cptr, current_obj, current_iface, parsing_group_attr, parsing_object_type, current_rule,\
        parsing_exception, members
    if cptr == 3 :
...
def p_new_rule_line(p):
    ...
    global parsing_a_rule, cptr, current_rule
    cptr += 1
    parsing_a_rule = True
    print(current_rule)
    rule_attr = ''
